...
'''
GET /drinks
It should be a public endpoint and contain only the drink.short() data representation
...
'''
POST /drinks
it requires the 'post:drinks' permission and it contains the drink.long() data representation
...
'''
PATCH /drinks/<id>
it requires the 'patch:drinks' permission and contains the drink.long() data representation 
...
'''
DELETE /drinks/<id>
it deletes the corresponding row for <id> and requires the 'delete:drinks' permission. It 
